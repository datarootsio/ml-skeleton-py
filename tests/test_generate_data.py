...
def test_outlier_removal(test_generate_df: pd.DataFrame) -> None:
    """
    ...
    assert type(remove_outliers(test_generate_df, params)) == pd.DataFrame
...
def test_generate_test_balanced(test_generate_test_df: None) -> None:
    """
    Tests whether file can be opened and whether it is a pd.DataFrame.
    """
...
def test_generate_test_imbalanced(test_generate_test_df: None) -> None:
    """
    Tests whether file can be opened and whether it is a pd.DataFrame.
    """
